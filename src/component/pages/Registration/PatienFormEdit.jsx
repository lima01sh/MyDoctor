...
const PatienFormEdit = () => {
    ...
    const handleSubmit = (e) => {
        ...
        formdata.append("thai_prefix", formData.thai_prefix||data.thai_prefix);
            ...
            <div className="row g-3">
                <div className="row d-flex flex-column flex-md-row-reverse">
                    ...
                    <div className="mb-5 col-lg-6 d-grid gap-2">
                        ...
                        //  value={formData.profile_image|| data.profile_image||""} 
                        defaultValue={data.profile_image} onChange={handleChange}/>
                    </div>
                </div>
                <div className="row">
                    ...
                    <div className="mb-2 col-lg-4">
                        ...
                        // value={formData.thai_firstname}
                        defaultValue={data.thai_firstname} onChange={handleChange} required />
                    </div>
                    <div className="mb-2 col-lg-4">
                        <input type="text" className="form-control" placeholder="นามสกุล" name="thai_lastname" 
                        // value={formData.thai_lastname} 
                        defaultValue={data.thai_lastname} onChange={handleChange} required />
                    </div>
                    ...
                    <div className="col-lg-3">
                        ...
                        // value={birthDate} 
                        defaultValue={data.birth_date} onChange={handleDateChange} max={maxtoday} required />
                    </div>
                    <div className="col-lg-2">
                        <p className="mb-0 fw-normal col-form-label">อายุปัจจุบัน : </p>
                        <input type="text" className="form-control" placeholder="อายุ" name="age" value={age || data.age||""} defaultValue={data.age} onChange={handleChange} disabled required />
                    </div>
                    ...
                    {(() => {
                        ...
                        case 'หนังสือเดินทาง(พาสปอร์ต)':
                            ...
                            <div className="col-lg-4">
                                ...
                                // value={formData.id_card_number} 
                                defaultValue={data.id_card_number} onChange={handleChange} required />
                            </div>
                            );
                    ...
                    <div className="col-lg-4">
                        ...
                        defaultValue={data.nationality} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-4">
                        ...
                        defaultValue={data.ethnicity} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-4">
                        ...
                        defaultValue={data.religion} onChange={handleChange} required />
                    </div> 
                    ...
                    <div className="col-lg-4">
                        ...
                        defaultValue={data.address} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-2">
                        ...
                        defaultValue={data.sub_district} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-2">
                        ...
                        defaultValue={data.district} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-2">
                        ...
                        defaultValue={data.province} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-2">
                        ...
                        defaultValue={data.zip_code} onChange={handleChange} required />
                    </div>
                    ...
                    <div className="col-lg-3">
                        ...
                        <div className="input-group">
                            ...
                            defaultValue={data.phone_number} onChange={handleChange} required />
                        </div>
                    </div>
                    <div className="col-lg-3">
                    ...
                    <div className="col-lg-3">
                        ...
                        defaultValue={data.occupation} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-3">
                    ...
                    <div className="col-lg-6">
                        ...
                        defaultValue={data.father_name} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-6">
                        ...
                        defaultValue={data.mother_name} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-4">
                        ...
                        defaultValue={data.emergency_contact_name} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-4">
                        ...
                        defaultValue={data.related_to} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-4">
                        ...
                        defaultValue={data.house_code} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-3">
                        ...
                        defaultValue={data.residence_type} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-6">
                        ...
                        <div className="row d-flex">
                            ...
                            <input type="text" className="form-control" placeholder="ที่อยู่ผู้ติดต่อได้" name="contact_address" value={isChecked ? emgAddress:data.contact_address||""} 
                    ...
                    <div className="col-lg-3">
                        ...
                        <div className="input-group mb-3">
                            <span className="input-group-text"><FontAwesomeIcon icon={faPhone} /></span>
                                ...
                                defaultValue={data.emergency_contact_phone} onChange={handleChange} required />
                        </div>
                    </div>
                    <div className="col-lg-6 mt-2">
                        ...
                        defaultValue={data.congenital_disease}  onChange={handleChange} required />
                    </div>
                    <div className="col-lg-6 mt-2">
                        ...
                        defaultValue={data.drug_allergy} onChange={handleChange} required />
                    </div>
                    <div className="col-lg-9 mt-2">
                        ...
                        <div className="row d-flex">
                            ...
                            defaultValue={data.treatment_right} onChange={handleChange} required />
                            </div>
                            <div className="col-12 col-md-9 mb-2 mb-md-0">
                            <input type="text" className="form-control" placeholder="ชื่อสิทธิการรักษา" name="insurance" 
                            // value={formData.insurance} 
                            defaultValue={data.insurance} onChange={handleChange} required />
                            </div>
                        </div>
                    </div>
                    <div className="col-lg-3">
                        ...
                        defaultValue={data.date_of_death} onChange={handleChange} max={maxtoday}  />
                    </div>
