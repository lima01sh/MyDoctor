...
import { faStethoscope,faCalendarDay,faComment,faTruckMedical} from '@fortawesome/free-solid-svg-icons';
  ...
  return (
    <div>
        <div className="p-4 mb-5 ">
            <h2 className="text-start display-6 fw-semibold text-titlepage">Lab ภายนอก</h2>
            <nav aria-label="breadcrumb" className="bg-light rounded-2 px-3 p-2">
                <ol className="breadcrumb mb-0">
                    ...
                    <li className="breadcrumb-item mb-0 active" aria-current="page"><FontAwesomeIcon className="me-1" icon={faTruckMedical} />Lab ภายนอก</li>
                </ol>
            </nav>
            <div className="mt-5">
                <div className="mt-3">
